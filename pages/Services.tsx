...
const SERVICES = [
  {
    id: 'AGENT',
    title: 'AGENT_FORCES',
    desc: 'We build and operate AI employees for your business. Sales agents that close leads. Support agents that answer customers 24/7. Content agents that write and publish. All running inside Slack, WhatsApp, SMS, or your web channel — you just assign the task.',
    icon: Users,
    path: '/onboarding',
    meta: 'YOUR_AI_EMPLOYEES',
  },
  {
    id: 'AGENTIRL',
    title: 'AGENTIRL_RUNTIME',
    desc: 'Already have AI agents? Connect them to AgentIRL. Our SDK wraps your LangChain, CrewAI, or custom agents and applies enterprise controls — policy enforcement before every tool call, cryptographic identity, delegation tokens, SOC 2 audit trails — without rewriting your code.',
    icon: Cpu,
    path: '/services/agentirl',
    meta: 'BRING_YOUR_OWN_AGENTS',
  },
  {
    id: 'ANALYTICS',
    title: 'AI_ANALYTICS',
    desc: 'Track what your AI agents are actually doing. See mission success rates, LLM token costs, tool failure patterns, and user behavior funnels in real time. Ask questions in plain English — "Why did conversions drop last week?" — and get data-backed answers.',
    icon: BarChart3,
    path: 'https://analytics.viktron.ai',
    meta: 'AGENT_OBSERVABILITY',
    external: true,
  },
  {
    id: 'RENTALS',
    title: 'AGENT_MARKETPLACE',
    desc: 'Need a specialist for a campaign or project but not a full-time agent team? Rent pre-configured agents by the week — Restaurant booking agents, Legal intake agents, Real estate qualification agents, and more. No long-term commitment.',
    icon: Sparkles,
    path: '/rent',
    meta: 'ON_DEMAND_WORKFORCE',
  }
];
