...
const InfrastructureBackground = React.memo(({ isMobile }: { isMobile: boolean }) => (
  <div className={`fixed inset-0 pointer-events-none -z-10 overflow-hidden ${isMobile ? 'opacity-20' : 'opacity-40'}`}>
    ...
    {/* Subtle tech lines - use a stable style object */}
    <div
...
InfrastructureBackground.displayName = 'InfrastructureBackground';
...
export const Layout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="relative min-h-screen overflow-x-clip bg-[#050505] text-white">
      ...
      {showBackground && <InfrastructureBackground isMobile={isMobile} />}
